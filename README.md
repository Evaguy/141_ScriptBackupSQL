...
- Try adding a way, for the users, to use a XML file or a JSON file, or any other text file, instead of modifing directly the variables in the script. Don't know if it's possible though...
